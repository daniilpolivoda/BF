...
-- ======================================================
-- ======================================================
-- MODULE 1: MOON TRACKER (FIXED & STABLE)
-- ======================================================
...
local function sendUpdate()
    ...
    if not sky or not sky.MoonTextureId then return end
    ...
    local Embed = {
        ...
        ["embeds"] = {{
            ...
            ["fields"] = {
                {["name"] = "👥 Игроков", ["value"] = tostring(playerCount), ["inline"] = true},
                {["name"] = "⏳ Время", ["value"] = timeInGame, ["inline"] = true},
...
print("🌙 Moon Finder Loaded (FIXED)")

task.spawn(function()
    while true do
        local sky = Lighting:FindFirstChildOfClass("Sky")
        if sky and sky.MoonTextureId and sky.MoonTextureId ~= LastTexture then
